    ...
    >
      <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a href="#features" className="font-medium hover:text-purple-700 transition-colors relative group">
            Features
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-700 transition-all duration-300 group-hover:w-full"></span>
          </a>
          <a href="#how-it-works" className="font-medium hover:text-purple-700 transition-colors relative group">
            How It Works
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-700 transition-all duration-300 group-hover:w-full"></span>
          </a>
          <a href="#security" className="font-medium hover:text-purple-700 transition-colors relative group">
            Security
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-700 transition-all duration-300 group-hover:w-full"></span>
          </a>
          <a href="#technical" className="font-medium hover:text-purple-700 transition-colors relative group">
            Technical
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-purple-700 transition-all duration-300 group-hover:w-full"></span>
          </a>
          <button className="bg-gray-900 text-white px-6 py-2.5 rounded-lg hover:bg-purple-700 
      ...
      >
        <div className="flex flex-col items-center justify-center h-full space-y-8">
          ...
          <button className="bg-gray-900 text-white px-8 py-3 rounded-lg text-xl hover:bg-purple-700 
