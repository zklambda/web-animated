      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-gray-700 leading-relaxed">
            zkλ provides end-to-end encrypted file transfers using elliptic
            curve cryptography and Solana's secure infrastructure.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <button
              ...
              className="bg-white/10 backdrop-blur-sm border border-black/10 px-8 py-4 rounded-xl 
            ...
            <div className="w-full md:w-1/2">
              <div className="bg-black/5 backdrop-blur-sm rounded-xl p-6 border border-black/5">
                ...
                <div className="font-mono text-sm text-gray-700 whitespace-pre-wrap">
                  ...
                  <br />
                  const encryptedFile ={" "}
                  <span className="text-blue-600">await</span> zkl.encrypt(
                  <br />
                  &nbsp;&nbsp;file,
                  <br />
                  &nbsp;&nbsp;recipientPubKey
                  ...
                  zkl.send(encryptedFile);
                  <br />
                  <br />
                  <span className="text-purple-600">// Recipient</span>
                  <br />
                  const transfer = <span className="text-blue-600">
                    await
                  </span>{" "}
                  zkl.getInbox();
                  <br />
                  const file = <span className="text-blue-600">await</span>{" "}
                  zkl.decrypt(
                  <br />
                  &nbsp;&nbsp;transfer.file
                  <br />
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="space-y-6">
                <div className="group relative">
                  <div
                    className="absolute inset-0 bg-gradient-to-r from-[#feffaf]/20 to-purple-200/20 
                    rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  ></div>
                  <div
                    className="relative bg-white/50 backdrop-blur-sm rounded-xl p-4 border border-black/5 
                ...
                <div className="group relative">
                  ...
                  >
                    <span className="text-lg font-medium text-gray-900">
                      Tamper-proof file transfer verification
                    </span>
                  </div>
                </div>
              </div>
