  ...
  const features = [
    {
      ...
      description:
        "Files are encrypted using Elliptic Curve Integrated Encryption Scheme (ECIES) ensuring only the intended recipient can access the content.",
      delay: 100,
    },
    {
      ...
      description:
        "Built on Solana's secure and fast blockchain infrastructure, providing tamper-proof record of all file transfers.",
      delay: 200,
    },
    {
      ...
      description:
        "All cryptographic keys are created and managed by users, ensuring complete control over their digital identity and file access.",
      delay: 300,
    },
    {
      ...
      description:
        "Automatic verification of file integrity and sender authenticity through cryptographic signatures and blockchain records.",
      delay: 400,
    },
  ];
      ...
      <div className="container mx-auto px-6 md:px-12 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            zkλ combines cutting-edge cryptography with blockchain technology to
            deliver a secure, private, and user-controlled file transfer
            experience.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div
                className="w-16 h-16 bg-[#feffaf] rounded-2xl flex items-center justify-center mb-6 
        ...
        <div className="mt-20 bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-10 shadow-xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-8 leading-relaxed">
                Join thousands of users who trust zkλ for their secure file
                transfer needs. Our platform combines the best of blockchain
                technology with state-of-the-art encryption.
              </p>
            </div>
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800/50 backdrop-blur rounded-xl p-8 border border-gray-700 hover:border-[#feffaf] transition-colors group">
              <h4 className="text-[#feffaf] text-xl font-bold mb-4">
                For Developers
              </h4>
              <p className="text-gray-300 mb-6">
                Integrate secure file transfers into your applications with our
                comprehensive API and SDKs.
              </p>
              <a
                href="https://docs.zk-lokomotive.xyz"
                className="inline-flex items-center text-[#feffaf] hover:text-white transition-colors"
              >
                View Documentation
                <svg
            ...
            <div className="bg-gray-800/50 backdrop-blur rounded-xl p-8 border border-gray-700 hover:border-[#feffaf] transition-colors group">
              ...
              <p className="text-gray-300 mb-6">
                Custom solutions and dedicated support for businesses requiring
                secure file sharing at scale.
              </p>
              <a
            ...
            <div className="bg-gray-800/50 backdrop-blur rounded-xl p-8 border border-gray-700 hover:border-[#feffaf] transition-colors group">
              ...
              <h6 className="text-[#feffaf]">Coming Soon...</h6>
            </div>
          </div>
        </div>
      </div>
